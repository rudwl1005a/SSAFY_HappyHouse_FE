<template>
    <!-- a tag href="#" 제외!! route url 이 board 에서 / 로 변경되는 문제 발생 -->
    <nav aria-label="Page navigation example">
        <ul class="pagination mb-0">
            ...
            <li v-for="index in endPageIndex - startPageIndex + 1" :key="index" v-bind:class="{ active: startPageIndex + index - 1 == $store.state.pagination.currentPageIndex }" class="page-item">
